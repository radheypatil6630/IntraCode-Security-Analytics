...
const Login = () => {
        ...
        return (
          <div className='min-h-screen bg-[linear-gradient(155deg,#02040a_30%,#162a86_80%)] p-4'>
            <Link to="/">
              <img src={logo} alt="Logo" className="w-40 h-14 mb-4" />      
        ...
        loop={true} 
        autoplay={true} 
            className="absolute left-32 top-10 w-[705px] h-[650px] bg-cover bg-center"
             
            />
      
           
            <div className="absolute left-[965px] top-[20px] w-[220px] h-[220px] rounded-full bg-gradient-to-b from-[#2FA4DD] to-[#721CC2]" />
            <div className="absolute left-[1500px] top-[508px] w-[170px] h-[170px] rounded-full bg-gradient-to-b from-[#2FA4DD] to-[#721CC2]" />
  ...
  <Link to="/forgot-password" className=" text-white font-istok text-[18px] text-center bg-gradient-to-b bg-[#626262]/20 rounded-[6px] py-2 px-2 hover:cursor-pointer  hover:text-red-500 font-medium">
    Forgot Password ?
  </Link> 


  <p className="text-white font-istok text-[20px] text-center ">
    Create an new account? <Link to="/signup" className="inline text-blue-400  cursor-pointer hover:underline ">Sign Up</Link>
  </p>
</div>
</div>
          </div>
