...
const Login = () => {
        ...
        return (
          ...
          <div className="relative flex items-center justify-center w-full  ">
            ...
            <div className="absolute left-[1500px] top-[568px] w-[170px] h-[170px] rounded-full bg-gradient-to-b from-[#2FA4DD] to-[#721CC2]" />
  ...
  <p className="text-white font-istok text-[20px] text-center ">
    Create an new account? <Link to="/signup" className="inline  cursor-pointer hover:underline hover:text-blue-400">Sign Up</Link>
  </p>
</div>
</div>
          </div>
