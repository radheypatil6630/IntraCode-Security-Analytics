    ...
    <div className='bg-[linear-gradient(155deg,#02040a_30%,#162a86_80%)]'>
      ...
      <div className='p-10 items-center justify-center flex flex-col'>
        ...
        <div className='grid md:grid-cols-3 gap-10 mt-10 w-[80%]'>
          <div className='h-[450px] w-[400px] bg-blue-950 rounded-2xl flex flex-col items-center justify-center  p-4 space-y-4 text-white
          hover:scale-105 hover:bg-blue-900/10 transition text-xl'>
            <p>Step 1</p>
          ...
          <div className='h-[450px] w-[400px] bg-blue-950 rounded-2xl flex flex-col items-center justify-center  p-4 space-y-4 text-white hover:scale-105 hover:bg-blue-900/10 transition text-xl'>
            <p>Step 1</p>
            <span className='h-20 w-20 rounded-full bg-gray-500 p-2'>
              <img src={logo} alt="IntraCode Logo" className='h-full w-full flex items-center justify-center object-cover'/>
            </span>
